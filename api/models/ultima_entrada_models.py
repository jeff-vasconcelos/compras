...
class UltimaEntrada(models.Model):
    ...
    produto = models.ForeignKey(Produto, on_delete=models.CASCADE, related_name='produto_ultentrada',
                                blank=True, null=True)
    fornecedor = models.ForeignKey(Fornecedor, on_delete=models.CASCADE, related_name='fornecedor_ultentrada',
                                   blank=True, null=True)
