...
class Produto(models.Model):
    ...
    cod_fabrica = models.CharField(max_length=255, null=True, blank=True)
    cod_ncm = models.CharField(max_length=255, null=True, blank=True)
    cod_auxiliar = models.CharField(max_length=255, null=True, blank=True)
    cod_depto = models.CharField(max_length=255, null=True, blank=True)
    cod_sec = models.CharField(max_length=255, null=True, blank=True)
