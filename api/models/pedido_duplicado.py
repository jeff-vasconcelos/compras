...
class PedidoDuplicado(models.Model):
    ...
    produto = models.ForeignKey(Produto, on_delete=models.CASCADE, related_name='produto_pedidosapi',
                                blank=True, null=True)
    fornecedor = models.ForeignKey(Fornecedor, on_delete=models.CASCADE, related_name='fornecedor_pedidosapi',
                                   blank=True, null=True)
    filial = models.ForeignKey(Filial, on_delete=models.CASCADE, null=True, blank=True, related_name='filial_pedidosapi')
    empresa = models.ForeignKey(Empresa, on_delete=models.CASCADE, related_name='empresa_pedidosapi',
                                blank=True, null=True)
