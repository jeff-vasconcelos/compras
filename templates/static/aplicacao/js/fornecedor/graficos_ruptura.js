const area_graf_um_fornec_ruptura = document.getElementById('div-grafico-umFornecRuptura')
const area_graf_dois_fornec_ruptura = document.getElementById('div-grafico-doisFornecRuptura')

const th_tabela_totais_ruptura_fornec = document.getElementById('th_tabela_totais_ruptura_fornec')
...
function GetNome_grafico_ruptura(CodProd) {
    ...
    graficoRuptura(filial, produto)
}


const graficoRuptura = (filial, produto) => {
    $.ajax({
        type: 'POST',
        ...
        success: (response) => {
            ...
            if (graficos.periodo <= 60) {
                area_graf_um_fornec_ruptura.style.width = "auto";
                area_graf_dois_fornec_ruptura.style.width = "auto";
            } else if (graficos.periodo > 60) {
                area_graf_um_fornec_ruptura.style.width = "2000px";
                area_graf_dois_fornec_ruptura.style.width = "2000px";
            }

            $("canvas#ChartSerieHistFornecRuptura").remove();
            $("canvas#ChartCoberturaFornecRuptura").remove();
            $("div#div-grafico-umFornecRuptura").append('<canvas id="ChartSerieHistFornecRuptura"></canvas>')
            $("div#div-grafico-doisFornecRuptura").append('<canvas id="ChartCoberturaFornecRuptura"></canvas>')

            //GRAFICO 01
            var ctxFornecRuptura = document.getElementById("ChartSerieHistFornecRuptura");
            var ChartSerieHistFornecRuptura = new Chart(ctxFornecRuptura, {
                data: {
                    datasets: [{
                        type: 'line',
                        yAxisID: 'B',
            ...
            //GRAFICO 02
            var ctxdoisFornecRuptura = document.getElementById("ChartCoberturaFornecRuptura");
            var ChartCoberturaFornecRuptura = new Chart(ctxdoisFornecRuptura, {
