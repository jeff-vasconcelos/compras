...
urlpatterns = [
    ...
    path(
        "filter-fornec/", products_chosen_by_provider_search, name="filter-fornecedor"
    ),
    path("filter-prod/", products_chosen_by_product_search, name="filter-produto"),
    ...
    path("get-product-parameters/", getProductParameters, name="getProductParameters"),
    path("home-graficos/", home_graficos, name="home_graficos"),
    # ALERTAS
    path(
        "alertas/excesso/curva/<str:curva>",
        alerta_excesso_curva,
        name="alerta_excesso_curva",
    ),
    path(
        "alertas/excesso/filial/<int:filial>",
        alerta_excesso_filial,
        name="alerta_excesso_filial",
    ),
    path(
        "alertas/ruptura/curva/<str:curva>",
        alerta_ruptura_curva,
        name="alerta_ruptura_curva",
    ),
    path(
        "alertas/ruptura/filial/<int:filial>",
        alerta_ruptura_filial,
        name="alerta_ruptura_filial",
    ),
    ...
    # FORNECEDOR ALERTAS
    path(
        "alertas/excesso/fornecedor/",
        excesso_fornecedor,
        name="alerta_excesso_fornecedor",
    ),
    path(
        "alertas/ruptura/fornecedor/",
        ruptura_fornecedor,
        name="alerta_ruptura_fornecedor",
    ),
    path(
        "alertas/excesso/fornecedor/<int:cod_fornecedor>/<int:filial>/",
        ver_excesso_fornecedor,
        name="ver_excesso_fornecedor",
    ),
    path(
        "alertas/ruptura/fornecedor/<int:cod_fornecedor>/<int:filial>/",
        ver_ruptura_fornecedor,
        name="ver_ruptura_fornecedor",
    ),
    ...
    path(
        "add-produtos-pedido-fornecedores/",
        add_pedido_sessao_fornecedores,
        name="add-produtos-pedido-fornecedores",
    ),
    ...
    # CONFIGURAÇÕES
    path(
        "configuracoes/editar/fornecedor/<int:pk>",
        editar_fornecedor_conf,
        name="config_edit_forn",
    ),
    path(
        "configuracoes/editar/parametros/<int:pk>",
        editar_parametro_conf,
        name="config_edit_param",
    ),
    path(
        "configuracoes/adicionar/email/", adicionar_email_conf, name="config_add_email"
    ),
    path("configuracoes/ver/email/", ver_emails_conf, name="config_ver_email"),
    path(
        "configuracoes/remover/email/<int:pk>",
        remover_email_conf,
        name="config_remove_email",
    ),
    path(
        "configuracoes/editar/email/<int:pk>",
        editar_email_conf,
        name="config_editar_email",
    ),
    path("configuracoes/email/", email_painel, name="email_painel"),
    path(
        "configuracoes/fornecedores/", fornecedores_painel, name="fornecedores_painel"
    ),
    # ACADEMY
